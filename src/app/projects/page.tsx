...
const projects = [
  {
    title: "Pechka",
    description:
      "A language learning app built around spaced repetition and immersive input.",
  ...
  },
  {
    ...
    description:
      "Web and mobile projects for clients in Japan and globally.",
    status: "live" as const,
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 md:py-24">
      ...
      <p className="mt-2 mb-12 text-lg text-muted-foreground">
        Things I&rsquo;m building and have built.
      </p>
